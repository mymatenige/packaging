...
case $projname in
    mythtv)
        ...
        if [[ "$BUILD_PRESET" == qt6 ]] ; then
            ...
            qt_libs="libqt5widgets5, libqt5sql5-mysql, libqt5xml5, libqt5network5, libqt5script5, libqt5webengine5, libqt5webenginewidgets5 "
        fi
